class RoundHistory:
    ...
    def zabelezi_rundu(
        ...
        stihovi_po_igracu,
        rezultat,
        pocetne_ruke=None,   # DODATO
        pocetni_talon=None   # DODATO
    ):
        runda = {
            ...
            "stihovi": list(self.current_tricks),
            "pocetne_ruke": pocetne_ruke if pocetne_ruke else [[], [], []], # DODATO
            "pocetni_talon": pocetni_talon if pocetni_talon else []         # DODATO
        }
